...
export default function TaxPlanning() {
  return (
    <>
      <section className="page-content-wrapper tax-planning-page">
        ...
        <Flex className="more-block">
          <div className="info-block">
            ...
            <p className="description">
              ...
              компаній та комплексному податковому плануванні. Ми
              спеціалізуємося на забезпеченні безпроблемного процесу реєстрації
              компаній у різних юрисдикціях по всьому світу. Наші експерти
              надають індивідуальне керівництво та розробляють надійні стратегії
              податкового планування, що відповідають унікальним потребам вашого
              бізнесу.
            </p>
            <p className="description">
              Ми розуміємо, що кожен бізнес має свої особливості та виклики.
              Тому ми пропонуємо персоналізований підхід, орієнтований на
              досягнення оптимальних результатів для наших клієнтів. Незалежно
              від того, чи ви тільки починаєте свій шлях на міжнародному ринку,
              чи вже маєте успішний бізнес, наші фахівці допоможуть вам
              орієнтуватися в складних юридичних і податкових питаннях.
            </p>
          </div>
        ...
        <div className="taxes-planning-why-block">
          ...
          <Flex justify="space-between">
            <Flex vertical={true} align="center" className="item-block">
              ...
              <p className="description">
                Наша команда складається з кваліфікованих професіоналів із
                великим досвідом у сфері міжнародного податкового права, що
                забезпечує прийняття обґрунтованих рішень та ефективне
        ...
        <Flex justify="space-between" className="tax-planning-grid">
          <div className="grid-wrapper">
            ...
            <Flex vertical={true} className="dark-cell transaction-block">
              ...
              <p>
                ...
                податками та ПДВ/GST для зменшення витрат і ризиків
                відповідності.
              </p>
            </Flex>
          ...
          <Flex vertical={true} className="image-wrapper-block">
            ...
            <p className="description">
              Ефективне податкове планування має важливе значення для
              оптимізації прибутковості та забезпечення дотримання нормативних
              вимог на глобальних ринках. Lionsinlaw надає ряд послуг, які
              допоможуть вам орієнтуватися в складних податкових ландшафтах:
            </p>
      ...
      <Flex vertical={true} className="partnering-block" align="center">
