...
export default function Contacts() {
  ...
  return (
    <>
      ...
      <Flex align="start" justify="space-between" className="law-contacts-wrapper">
        <div>
          <p className="title">
            Контакти <span className="selected">LionsInLaw</span>
          </p>
          <p className="description">Швидкий і зручний зв'язок для вирішення ваших питань</p>
          {
            config.contactPhones.map((item, index) => <Flex key={`${item.flag}:${index}`} align="center" justify="space-between" className="phone-wrapper">
              <Flex align="center">
        ...
        <div>
          ...
          >
            ...
            <Flex align="center" justify="space-between" className="form-item-wrapper">
              <Form.Item label="Що ми можемо вам допомогти" name="theme" required={true}>
            ...
            <Form.Item>
              <Checkbox onChange={()=>{}}>Електронна пошта та адреса для виставлення рахунків залишаються незмінними</Checkbox>;
            </Form.Item>
            <Form.Item>
              <Button
                type="primary"
