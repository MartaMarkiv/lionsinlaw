...
export default function ScotlandCompany() {
  return <section className="scotland-company-page">
    <Flex className="scotland-header" justify="space-between" align="flex-end">
      <Flex vertical={true}>
    ...
    <CompanySubDescriptionBlock
      title={
        <p className="title">
          Реєстрація компанії в <span className="selected-text"> Шотландії:</span> Ваш шлях до успіху з <span className="selected-text"> LionsInLaw</span>
        </p>
      }
